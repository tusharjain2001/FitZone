...
const Plans = () => {
  return (
    <div className="planscont ">
      <div className="plansheader flex justify-between text-white p-8 text-5xl font-extrabold tracking-widest italic ">
        <span className="text-stroke-3">READY TO</span>
        <span>BEGIN YOUR</span>
        <span className="text-stroke-3">JOURNEY WITH US</span>
      </div>

    <div className="plancard flex flex-row p-8 items-center justify-center gap-[3rem]">
    ...
    text={"BASIC PLAN"}
    price={"25"}
    data={["2 hours of excercises","Free consultation of coaches","Access to the community"]}
    ...
    text={"PREMIUM PLAN"}
    price={"30"}
    data={["5 hours of excercises","Free consultation of coaches","Access to the community","Access to swimming pool"]}
    ben={"See more benefits"}
    img2 = {<FaLongArrowAltRight size={20}
    />}
